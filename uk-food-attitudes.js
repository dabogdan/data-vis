function UKFoodAttitudes() {
  ...
  this.preload = function() {
    var self = this;
    this.data = loadTable(
      './data/food/attitudestoukfood-26jun19.csv', 'csv', 'header',
  ...
  this.setup = function() {
    ...
    // Set select position.
    this.select.position(300,500);
    // Fill the options with all question types.
  ...
  this.draw = function() {
    ...
    // Get the value of the question type we're interested in from the
    // select item.
    ...
    var colours = ['darkgreen', 'lightgreen', 'yellow', 'orange', 'red'];

    // Make a title.
    var title = questionType;
